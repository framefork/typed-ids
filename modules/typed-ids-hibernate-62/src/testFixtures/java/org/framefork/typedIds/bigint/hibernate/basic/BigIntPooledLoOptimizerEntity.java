...
public class BigIntPooledLoOptimizerEntity
{
    ...
    public static final String TABLE_NAME = "bigint_pooled_lo_optimizer";

    @jakarta.persistence.Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pooled_lo_gen")
    @org.hibernate.annotations.GenericGenerator(
        name = "pooled_lo_gen",
        strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
        parameters = {
            @Parameter(name = "sequence_name", value = "pooled_lo_seq"),
    ...
    public BigIntPooledLoOptimizerEntity(final String data)
    {
        this.data = data;
    }

    @SuppressWarnings("NullAway")
    protected BigIntPooledLoOptimizerEntity()
    {
    }
